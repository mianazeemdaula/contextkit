#!/usr/bin/env bash
# Registers the ContextKit native messaging host for Google Chrome on macOS.
# Verified 2026-05-28 against:
#   https://developer.chrome.com/docs/extensions/develop/concepts/native-messaging
# User-scoped install dir: ~/Library/Application Support/Google/Chrome/NativeMessagingHosts/
