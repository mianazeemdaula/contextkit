...
ContextKit community a harassment-free experience for everyone, regardless of
...
This Code of Conduct applies within all community spaces (GitHub repos, issues,
pull requests, Discord, X/Twitter, in-person events) and also applies when an
individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainers at **conduct@contextkit.app** <!-- TODO: real address -->.
...
1. **Correction** — Private written warning, clarifying the violation and why
   it was inappropriate. A public apology may be requested.
